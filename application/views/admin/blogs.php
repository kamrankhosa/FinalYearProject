                                ...
                                <table class="table table-striped table-bordered table-hover text-center" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                           ...
                                           <td><a href="<?php echo base_url();?>admin/delete_blog?id=<?php echo base64_encode($blog->ID); ?>" onclick=""><i class="fa fa-trash"></i> </a> | <a href=""><i class="fa fa-pencil"></i></a></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                     <thead>
